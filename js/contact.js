jQuery(function () {
    ...
    messagetext.focusout(function () {
        if (messagetext.val() == '') { messagetext.text('Mesaj'); }
    });
    messagetext.focus(function () {
        if (messagetext.val() == 'Mesaj') { messagetext.text(''); }
    });
    jQuery(".button").click(function () {
        ...
        jQuery.ajax({
            ...
            data: dataString,
            success: function () {
                jQuery('#contactform').html("<div id='mesaj'></div>");
                jQuery('#mesaj').html("<b>Contact Form Submitted!</b>")
